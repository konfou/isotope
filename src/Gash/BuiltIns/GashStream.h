...
#ifndef __GASHSTREAM_H__
#define __GASHSTREAM_H__
...
class GashStream : public WrapperObject
{
friend class Engine;
public:
	GQueue m_value;
...
public:
	...
	{
		pEngine->SetThis(new GashStream(pEngine));
	}
