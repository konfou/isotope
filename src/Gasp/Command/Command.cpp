...
void ShowUsage()
{
	printf(
		...
		"   gasp\n"
		"\n"
		"To build and run main in 'myscript.gasp':\n"
		"   gasp run myscript.gasp\n"
		"\n"
		"To run main in 'myapplication.xlib':\n"
		"   gasp run myapplication.xlib\n"
		"\n"
		"To build an xlib from the files 'a.gasp', 'b.gasp', and 'c.gasp'\n"
		"   gasp build a.gasp b.gasp c.gasp\n"
		"\n"
		"To build all the files listed in 'myproject.proj':\n"
		"   gasp build myproject.proj\n"
		"\n"
		"To disassemble 'myapplication.xlib':\n"
		"   gasp disassemble myapplication.xlib\n"
		"\n"
		"To generate a .cpp file from 'myproject.proj':\n"
		"   gasp cpp myproject.proj\n"
		"\n"
...
bool RebuildMainLib(const char* szAppPath)
{
	...
	COProject* pProject = COProject::LoadProject(NULL, "../src/Gasp/MainLib/MainLib.proj", &errorHandler);
	if(!pProject)
		return false;
