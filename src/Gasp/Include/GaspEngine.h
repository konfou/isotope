...
#ifndef __GASPENGINE_H__
#define __GASPENGINE_H__
...
typedef struct
{
	...
	union
	{
		...
		GaspString* pStringObject;
		GaspFloat* pFloatObject;
		GaspStream* pStreamObject;
		MBigInt* pBigInt;
	};
} EVar;
...
bool CommandBuild(ErrorHandler* pErrorHandler, const char* szGaspPath, int argc, char** argv);
